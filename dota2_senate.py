...
# And in the round 2,
# the third senator can just announce the victory since he is the only guy in the senate who can vote.
...
class Solution(object):
    def predictPartyVictory(self, senate):
        ...
        while rd[0] != 0 and rd[1] != 0:
            i = 0
            while i < len(num):
                if num[i] == 'R' and bans_rd[0] > 0:
                    del num[i]
                    rd[0] -= 1
                    bans_rd[0] -= 1
                elif num[i] == 'R' and bans_rd[0] == 0:
                    bans_rd[1] += 1
                    i += 1
                elif num[i] == 'D' and bans_rd[1] > 0:
                    del num[i]
                    rd[1] -= 1
                    bans_rd[1] -= 1
                elif num[i] == 'D' and bans_rd[1] == 0:
